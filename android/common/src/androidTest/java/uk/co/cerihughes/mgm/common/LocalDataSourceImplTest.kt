...
class LocalDataSourceImplTest {
    ...
    fun testDataLoader() {
        ...
        val events = uk.co.cerihughes.mgm.common.repository.GsonFactory.createGson().fromJson(localData , Array<uk.co.cerihughes.mgm.common.model.Event>::class.java).toList()
